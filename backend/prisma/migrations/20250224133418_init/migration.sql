-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'SYSTEM', 'ASSISTANT');
...
-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "AIAgent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
